...
const Navbar = () => {
  ...
  return (
    <nav 
    className={`${styles.paddingX} w-full items-center flex py-5 fixed top-0 z-20 bg-primary`}
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <p className="text-white text-[18px] font-bold cursor-pointer flex">Rodrigo Seminario &nbsp; 
